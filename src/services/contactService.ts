...
import { type PrismaClient, type ContactType as PrismaContactType } from "@prisma/client";
...
export function useContactService(prisma: PrismaClient) {
  return {
    /**
...
export type ContactService = ReturnType<typeof useContactService>;