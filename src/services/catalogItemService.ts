...
const service = {
   ...
   * {@link requestDto} or `requestDto.type` is not specified, all of the catalog items
   * will be retrieved.
   * 
   ...
   * containing the information of the catalog item.
   * 
...
export function useCatalogItemService() {
  return service;
}